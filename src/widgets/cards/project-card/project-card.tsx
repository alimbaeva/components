...
import { projectCardTextsMock } from '@/mocks/cards-mocks'
...
const ProjectCard = (props: Props) => {
  ...
  return (
    <BlockWithDescription
      id='service_card'
      title={projectCardTextsMock.title}
      descriptionContent={projectCardTextsMock.descriptionContent}
      titleLinks={titleLinksMock.gitHub}
      linkToCode={projectCardTextsMock.linkToCode}
    >
      <div className='flex w-60 flex-1 shrink-0 basis-0 flex-col items-start gap-0 rounded-2xl bg-white shadow-sm'>
        ...
        <div className='flex flex-col gap-1 self-stretch p-4'>
          <h3 className='line-clamp-1 text-xl leading-tight font-bold text-slate-900'>
            {devTitle}
          </h3>
